...
server "www.sasabo.tk", user: "deploy", roles: %w{app db web}
...
set :pg_database, "books_app_production"
set :pg_username, "books_app"
set :pg_password, ENV["BOOKS_APP_DATABASE_PASSWORD"]
set :pg_extensions, ["citext", "hstore"]
set :pg_encoding, "UTF-8"
set :pg_pool, "100"

# nginx setup
set :nginx_config_name, "www.sasabo.tk"
